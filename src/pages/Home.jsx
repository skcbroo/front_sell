    ...
    <NavbarLayout>
      ...
      <section className="bg-gradient-to-r from-white via-[#A6B8C7] to-[#222B3B] text-black py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg mb-8">Receba em 24 horas — 100% legal e seguro</p>
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4 text-sm text-black font-medium">
      ...
      <section className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card
            ...
            text="Receba o dinheiro em até 24 horas após aprovação dos documentos"
          />
          <Card
            icon="💰"
            title="Custo Menor"
            text="Taxas mais baixas que empréstimos bancários tradicionais"
          />
          <Card
            icon="📋"
            title="Sem Burocracias"
            text="Processo simples e documentação mínima necessária"
          />
        </div>
      </section>
      ...
      <section id="vantagens" className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-center text-2xl font-bold text-[#1A202C] mb-8">
            Vantagens vs Empréstimo Bancário
          </h2>
          <div className="overflow-x-auto">
            <table className="w-full border-collapse rounded-lg overflow-hidden">
              <thead>
                <tr className="bg-[#EBF4FF] text-black border-b-2 border-black">
                  <th className="px-4 py-2 text-center font-bold border-r border-black">
                    Característica
                  </th>
                  <th className="px-4 py-2 text-center font-bold border-r border-black">
                    MIDLEJ Capital
      ...
      <section id="contato" className="py-16 px-4 bg-transparent">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-700 mb-2">
            Email: contato@midlejcapital.com.br
          </p>
          <p className="text-gray-700 mb-4">
            Endereço: SHIS QI 19, Conjunto 04, Casa 19 – Lago Sul, Brasília/DF
          </p>
          <a
            href="https://wa.me/5561996204646"
